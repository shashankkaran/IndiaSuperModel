          ...
          <div class="flex flex-wrap -m-4">
            <div class="p-4 md:w-1/2 w-full">
              <div data-aos="zoom-out" class="h-full bg-gray-800 bg-opacity-40 p-8 rounded">
                ...
                <p class="leading-relaxed mb-6">We are about to add the testimonials from our clients in this section which will reflect how we have helped them to grow their brand</p>
                <a class="inline-flex items-center">
                  <img alt="testimonial" src="https://dummyimage.com/106x106" class="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
                  <span class="flex-grow flex flex-col pl-4">
                    <span class="title-font font-medium text-white">Name of person</span>
      ...
      <section data-aos="zoom-in" class="text-gray-400 bg-gray-900 body-font">
        <div class="container px-5 py-24 mx-auto">
          <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
            ...
            <p class="leading-relaxed text-lg">We are about to add the testimonials from our clients in this section which will reflect how we have helped them to grow their brand</p>
            <span class="inline-block h-1 w-10 rounded bg-yellow-500 mt-8 mb-6"></span>
            <h2 class="text-white font-medium title-font tracking-wider text-sm">Name of person</h2>
